<?
	...
	***********************************************************************************************
	...
	$sAutoCorrect       = $objDb->getField(0, "auto_correct");
...
?>
  ...
  <script type="text/javascript" src="scripts/<?= $sCurDir ?>/edit-school.js"></script>
</head>
...
?>
		  ...
		  <label for="filePicture">Logo <span><?= (($sPicture == "") ? '(optional)' : ('(<a href="'.(SITE_URL.SCHOOLS_IMG_DIR.$sPicture).'" class="colorbox">'.substr($sPicture, strlen("{$iSchoolId}-")).'</a> - <a href="'.$sCurDir.'/delete-school-picture.php?SchoolId='.$iSchoolId.'&Index='.$iIndex.'">Delete</a>)')) ?></span></label>
		  ...
		  <label for="cbAutoCorrect" class="noPadding"><input type="checkbox" name="cbAutoCorrect" id="cbAutoCorrect" value="Y" /> Auto Correct the School Location</label>
