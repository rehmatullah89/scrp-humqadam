<?
	...
	***********************************************************************************************
	...
	$sEmail    = IO::strValue('txtUsername');
	...
	$sSQL = "SELECT id, type_id, name, provinces, districts, schools, level, records, theme, status
			 FROM tbl_admins
	...
	if ($objDb->query($sSQL) == true)
	{
		if ($objDb->getCount( ) == 1)
		{
			if ($objDb->getField(0, "status") == "A")
			{
				...
				$_SESSION["AdminTypeId"]    = $objDb->getField(0, "type_id");
